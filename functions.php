...
if ( ! function_exists( 'sds_copyright_branding' ) ) {
	...
	function sds_copyright_branding( $text, $theme_name ) {
		return '<a href="http://slocumthemes.com/wordpress-themes/epic-free/" target="_blank">' . sprintf( __( '%1$s by Slocum Design Studio', 'epic' ), $theme_name ) . '</a>';
	}       
}
 ...
 *
 */
function next_meeting_widget_init() {

    register_sidebar( array(
		'name' => 'Next meeting area',
		'id' => 'next_meeting_area',
		'before_widget' => '<div>',
		'after_widget' => '</div>',
	) );
}

add_action( 'widgets_init', 'next_meeting_widget_init' );